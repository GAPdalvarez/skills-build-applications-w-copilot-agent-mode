      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4 octofit-navbar">
        <div className="container-fluid">
          <NavLink className="navbar-brand d-flex align-items-center" to="/">
            <img src={octofitLogo} alt="OctoFit Logo" className="octofit-logo me-2" style={{height: '40px', width: '40px', objectFit: 'contain'}} />
          ...
          <Route path="/" element={
            <div className="card text-center">
              <div className="card-body">
                ...
                <NavLink to="/leaderboard" className="btn btn-outline-primary m-2">Leaderboard</NavLink>
              </div>
            </div>
          } />
        </Routes>
